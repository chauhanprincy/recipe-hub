...
import { LogOut, Mail, MapPin, Sparkles } from 'lucide-react';
...
const Profile = () => {
  ...
  }, [profile.bio, profile.location, profile.favoriteCuisine]);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-2xl text-lg text-gray-600 dark:text-gray-300">
          Keep your basic details and favorite culinary preferences close at hand.
        </p>
      </div>
